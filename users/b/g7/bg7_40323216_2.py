...
bg7_40323216_2 = Blueprint('bg7_40323216_2', __name__, url_prefix='/bg7_40323216_2', template_folder='templates')
...
@bg7_40323216_2.route('/eighteenthirty/<x>/<y>')
@bg7_40323216_2.route('/eighteenthirty', defaults={'x':0, 'y':0})
...
@bg7_40323216_2.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
